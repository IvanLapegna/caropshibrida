...
class NotificationService {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      final String tzName =
          tzInfo.identifier; // p. ej. "America/Argentina/Buenos_Aires"
  ...
  Future<void> scheduleNotification({
    ...
    if (!scheduledTz.isAfter(tzNow)) {
      print(
        'WARNING: scheduled time is in the PAST. Android normalmente no disparará esta notificación inmediatamente.',
      );
